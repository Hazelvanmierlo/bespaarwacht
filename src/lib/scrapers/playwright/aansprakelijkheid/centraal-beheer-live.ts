...
export async function scrapeCentraalBeheerAvp(input: LiveScraperInput): Promise<LiveScraperResult> {
  ...
  try {
    ...
    await page.goto("https://www.centraalbeheer.nl/verzekeringen/aansprakelijkheidsverzekering", {
