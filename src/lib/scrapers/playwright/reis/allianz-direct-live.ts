...
export async function scrapeAllianzDirectReis(input: LiveScraperInput): Promise<LiveScraperResult> {
  ...
  try {
    ...
    await page.goto("https://www.allianzdirect.nl/reisverzekering/", {
