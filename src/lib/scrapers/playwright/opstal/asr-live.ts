...
export async function scrapeAsrOpstal(input: LiveScraperInput): Promise<LiveScraperResult> {
  ...
  try {
    ...
    await page.goto("https://www.asr.nl/verzekeringen/opstalverzekering", {
