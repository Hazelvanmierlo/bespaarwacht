...
export function WhatsAppFloat() {
  return (
    ...
    >
      ...
      <span className="absolute right-full mr-3 top-1/2 -translate-y-1/2 bg-white text-gray-800 text-sm font-medium px-3 py-1.5 rounded-lg shadow-md whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity">
        Stuur je rekening via WhatsApp
      </span>
    </a>
  );
}
